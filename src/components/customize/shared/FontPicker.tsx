  ...
  return (
    <div className="mt-3">
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
        {options.length === 0 ? (
          <p className="col-span-full text-center text-xs opacity-50">No fonts available for this script.</p>
        ) : (
          options.map((f) => (
            <button
              type="button"
            ...
            >
              <span className="block text-2xl" style={{ fontFamily: f.family, fontStyle: f.italic ? "italic" : "normal" }}>
                Aa
              </span>
